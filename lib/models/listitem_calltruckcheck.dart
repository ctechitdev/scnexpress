...
class ListItemCallTruckCheckModel {
  ...
  ListItemCallTruckCheckModel copyWith({
    String? bill_code,
    String? mtl_name,
    String? mtl_weight,
    String? mtl_size,
    ...
    return ListItemCallTruckCheckModel(
  ...
  factory ListItemCallTruckCheckModel.fromMap(Map<String, dynamic> map) {
    return ListItemCallTruckCheckModel(
  ...
  factory ListItemCallTruckCheckModel.fromJson(String source) =>
      ListItemCallTruckCheckModel.fromMap(json.decode(source));

  @override
  String toString() {
    return 'ListItemCallTruckCheckModel(bill_code: $bill_code, mtl_name: $mtl_name, mtl_weight: $mtl_weight, mtl_size: $mtl_size, mtl_am: $mtl_am, mtl_total_price: $mtl_total_price, create_date: $create_date, ccy: $ccy, cod: $cod)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is ListItemCallTruckCheckModel &&
