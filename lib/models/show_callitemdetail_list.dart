...
class showCallItemdetaillistModel {
  ...
  showCallItemdetaillistModel copyWith({
    String? bill_code,
    String? mtl_name,
    String? mtl_weight,
    String? mtl_size,
    ...
    return showCallItemdetaillistModel(
  ...
  factory showCallItemdetaillistModel.fromMap(Map<String, dynamic> map) {
    return showCallItemdetaillistModel(
  ...
  factory showCallItemdetaillistModel.fromJson(String source) =>
      showCallItemdetaillistModel.fromMap(json.decode(source));

  @override
  String toString() {
    return 'showCallItemdetaillistModel(bill_code: $bill_code, mtl_name: $mtl_name, mtl_weight: $mtl_weight, mtl_size: $mtl_size, mtl_am: $mtl_am, mtl_total_price: $mtl_total_price, create_date: $create_date, ccy: $ccy, cod: $cod)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is showCallItemdetaillistModel &&
